...
#   Change Prompt
#   ------------------------------------------------------------
    PS1="\[\e[32m\]______________________________________________________________\n| "
    PS1="${PS1}\[\e[35m\]\w\[\e[32m\] \n| => \[\e[0m\]"
    export PS1
...
#   ------------------------------------------------------------
    ...
    # Spark Installer
    PATH="~/spark-installer:${PATH}"
    PATH="~/.local/bin:${PATH}"
    export PATH

#   Set Default Editor (change 'Nano' to the editor of your choice)
#   ------------------------------------------------------------
    export EDITOR="/Applications/Visual Studio Code.app/Contents/Resources/app/bin"
...
[ "$BASH" ] || [ "$ZSH" ] && . '/Users/zacharybruno/.platformsh/shell-config.rc' 2>/dev/null || true
